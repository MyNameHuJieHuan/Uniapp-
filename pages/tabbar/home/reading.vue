<template>
	<view class="reading">
		<uni-nav-bar color="#ffffff" background-color="#00aded" :status-bar="true" left-icon="arrowleft" left-text="返回" :rightIcon="bookMap.statue" @clickRight="addBook" fixed="true"
